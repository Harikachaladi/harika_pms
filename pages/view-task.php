...
<body>
  ...
  <footer id="footer">
    <div id="slideContainer">
      <div id="slide1">
        ...
        <div id="socialBtnContainer">
          <a href="https://www.instagram.com/attitude_ka_icon/?hl=en"><i class="fa-brands fa-instagram"></i></a>
          <a href="linkedin.com/in/harika-chaladi-1b1022274"><i class="fa-brands fa-linkedin"></i></a>
        </div>
    ...
    <div id="developed">developed by @CHALADI HARIKA</div>
  </footer>
</body>
